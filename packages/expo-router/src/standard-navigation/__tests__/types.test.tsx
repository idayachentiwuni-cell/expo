...
import {
  ...
  type DefaultRouterNavigationProps,
  type StandardNavigationAction,
} from '../index';
...
// ---------------------------------------------------------------------------
// screenListeners / screenOptions function form
// ---------------------------------------------------------------------------

type Props = DefaultRouterNavigationProps<
...
// ---------------------------------------------------------------------------
// Returned component exposes typed .Screen / .Protected and accepts the function-form props
// ---------------------------------------------------------------------------
