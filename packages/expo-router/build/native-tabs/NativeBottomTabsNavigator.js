...
const NativeTabsNavigatorWithContext = (0, standard_navigation_1.createStandardRouterNavigator)(NativeTabsContent, NativeBottomTabsRouter_1.NativeBottomTabsRouter, { useOnlyUserDefinedScreens: true });
function NativeTabsNavigatorWrapper(props) {
    ...
    const { children, backBehavior = defaultBackBehavior, labelStyle, iconColor, blurEffect, backgroundColor, badgeBackgroundColor, indicatorColor, badgeTextColor, shadowColor, rippleColor, disableIndicator, labelVisibilityMode, screenListeners, ...rest } = props;
    ...
    return ((0, jsx_runtime_1.jsx)(NativeTabsNavigatorWithContext, { ...props, children: triggerChildren, nonTriggerChildren: nonTriggerChildren, screenOptions: screenOptions, screenListeners: screenListeners, 
        // Passed to TabRouter
