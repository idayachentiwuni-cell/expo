...
import type { DefaultRouterNavigationProps } from '../standard-navigation';
/**
...
export interface NativeTabsProps extends PropsWithChildren {
     ...
     * ```
     */
    screenListeners?: DefaultRouterNavigationProps<TabNavigationState<ParamListBase>, {}, NativeTabNavigationEventMap, any>['screenListeners'];
    /**
